...
export const translations = {
  en: {
    ...
    article: { loading: 'Loading article...', missing: 'No article was specified.', unavailable: 'This article could not be loaded.', eyebrow: 'Product and technology notes', read: 'read', back: 'Back to insights' },
  ...
  es: {
    ...
    article: { loading: 'Cargando artículo...', missing: 'No se especificó un artículo.', unavailable: 'No fue posible cargar este artículo.', eyebrow: 'Notas de producto y tecnología', read: 'de lectura', back: 'Volver a ideas' },
