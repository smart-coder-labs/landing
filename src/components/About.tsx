        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="text-lg mb-6 text-slate-700 dark:text-slate-300">
              Soy un desarrollador de software apasionado por crear soluciones elegantes 
              y eficientes. En SmartCoderLabs, comparto conocimientos y experiencias 
              sobre ingeniería de software, inteligencia artificial, 
              buenas prácticas de desarrollo y arquitectura de software.
            </p>
            <p className="text-lg mb-8 text-slate-700 dark:text-slate-300">
              Mi enfoque se centra en la calidad, la escalabilidad y la aplicación de tecnologías
